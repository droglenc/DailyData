...
df <- readxl::read_excel("Tracking Myself Spreadsheet.xlsx",
  ...
  mutate(mon=lubridate::month(time,label=TRUE,abbr=TRUE),
         ...
         eat_habits1=lag(eat_habits,n=1),
         eat_habits2=lag(eat_habits,n=2),
         eat_habits7=lag(eat_habits,n=7),
         ...
         electrolytes1=lag(electrolytes,n=1),
         electrolytes2=lag(electrolytes,n=2),
         electrolytes7=lag(electrolytes,n=7),
  ...
  select(date,yr,mon,day,
         ...
         starts_with("eat_habits"),pre_snacks,
         starts_with("electrolytes"),starts_with("electrolytesb"),
